This project is build for the purpose of Round 2 for Zithara Technologies becuase it is a task-driven assessment.

Customer requirments are :
build a REACT and NODE JS application with PostgreSQL database which has the functionality as stated below.
